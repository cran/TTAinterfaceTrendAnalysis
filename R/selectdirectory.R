...
##### copier ici a partir de 'Save.directory <- function...' ligne 65 jusqu'a 'open <- tkgrid(HELP4.but...' du fichier TTAinterface.R #####
...
#_______________________________________________________________________________________________________________________________________Onglet analyses
	 ...
	 tkgrid(tklabel(diagFrame,text="Pettitt test (cassure)  "),rb30, sticky="w")
