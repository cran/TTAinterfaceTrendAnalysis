...
AIDE4 <- tktext(aide4, height=46, width=120)
tkpack(AIDE4)
...
tkpack(tkbutton(aide4, text="Ok", command=function(){ tkdestroy(aide4) }, width=20 ), side="bottom")
tkconfigure(AIDE4, state="disabled")
